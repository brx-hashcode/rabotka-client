...
const PhoneNumberInputRoot = RPNInput.default;
...
type PhoneInputProps = Omit<
  ...
  "onChange" | "value" | "ref"
> &
  Omit<RPNInput.Props<typeof PhoneNumberInputRoot>, "onChange"> & {
    ...
    >
      <PopoverTrigger asChild>
        <Button
          type="button"
          variant="outline"
          className="flex h-10 gap-1 rounded-s-lg rounded-e-none border-0 shadow-none px-3 focus:z-10"
          disabled={disabled}
        >
          <FlagComponent
