...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      // A fixed 4px, not `rounded-sm`. The global --radius is 1rem, which makes
      // --radius-sm 12px — on a 16px box that is a full circle, so every
      // checkbox in the app read as a radio button.
