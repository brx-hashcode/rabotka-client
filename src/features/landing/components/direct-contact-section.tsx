          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex items-center gap-3 bg-card p-4 rounded-2xl shadow-soft flex-1">
                ...
                <div>
                  <p className="font-semibold text-foreground">{directContactContent.methods[0].title}</p>
                  <p className="text-sm text-muted-foreground">{directContactContent.methods[0].subtitle}</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3 bg-card p-4 rounded-2xl shadow-soft flex-1">
                ...
                <div>
                  <p className="font-semibold text-foreground">{directContactContent.methods[1].title}</p>
                  <p className="text-sm text-muted-foreground">{directContactContent.methods[1].subtitle}</p>
                </div>
              </div>
            </div>
